...
[![Version](https://img.shields.io/badge/version-1.11.0-7c5cff?style=flat-square)](https://github.com/ChenyangLT/ECHO-Multi-Music-Sources/releases)
...
1. 到 [**Releases**](https://github.com/ChenyangLT/ECHO-Multi-Music-Sources/releases/latest) 下载
   **`echo.multi-music-sources-1.11.0.echomod`**（[直链](https://github.com/ChenyangLT/ECHO-Multi-Music-Sources/releases/download/v1.11.0/echo.multi-music-sources-1.11.0.echomod)；
   仓库里的 `dist/` 也放了同一份）；
...
(tested with 1.7.2). Install the loader first, then grab `echo.multi-music-sources-1.11.0.echomod` from
